...
def display_ascii_art():
    art = [
        ...
        "║  Created for Programming I course with José  ║",
        "║ Presented by Martí Blanes and Šimon Sedláček ║",
        "╠══════════════════════════════════════════════╣",
        "║       Sit back, take popcorn and enjoy!      ║",
        "╚══════════════════════════════════════════════╝"
    ]
    total_duration = 1.5
    delay = total_duration / len(art)
    for line in art:
        print(line)
        time.sleep(delay)
display_ascii_art()
...
def test_house_price_predictor():
    ...
    try:
        ...
        print(f"Forecasting failed: {traceback.format_exc()}")
        return
